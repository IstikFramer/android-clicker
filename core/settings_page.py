...
class SettingsPage(QWidget):
    ...
    def _build_ui(self) -> None:
        ...
        reset_button = QPushButton("Сбросить настройки", content)
    ...
    def _updates_section(self) -> QFrame:
        ...
        button = QPushButton("Проверить сейчас", card)
    ...
    def _about_section(self) -> QFrame:
        ...
        github = QPushButton("GitHub", card)
