  ...
  function renderFooter(root) {
    ...
    root.appendChild(ML.el("div", { class: "container" }, [
        ...
        ML.el("div", {}, [
          ...
          ML.el("p", {
            ...
            text: "Каталог манги, манхвы, маньхуа и комиксов: свежие главы, рейтинги, закладки и удобная читалка. " +
              "Проект демонстрационный — все обложки и страницы сгенерированы как заглушки, реальные тайтлы пока не загружены."
          })
        ]),
        ML.el("div", {}, [
      ...
      ML.el("div", { class: "footer-bottom" }, [
        ...
        ML.el("span", { text: "Все обложки и страницы — сгенерированные заглушки" })
      ])
    ]));
  }
